    ...
    <div className="p-4 sm:p-8 max-w-5xl mx-auto space-y-8 sm:space-y-10">
      ...
      <div className="space-y-3 animate-slide-up" style={{ animationDelay: "0s", animationFillMode: "both" }}>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] font-mono text-[#FFF8F0]/40 tracking-wider">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-slide-up" style={{ animationDelay: "0.06s", animationFillMode: "both" }}>
          {latestByEngine.map((log) => {
            ...
            return (
              ...
              >
                <h3 className="text-lg font-serif text-[#FFF8F0]/90 mb-1">
                  {log.engineName}
                </h3>
                <p className="text-[11px] font-mono text-[#FFF8F0]/30 tracking-wider mb-4">
                ...
                <p className="text-[10px] font-mono text-[#FFF8F0]/25">
            ...
            {recentActivity.map((log) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[11px] font-mono text-[#FFF8F0]/25">
                    &middot;
                  </span>
                  <span className="text-[11px] font-mono text-[#FFF8F0]/40 tracking-wider">
                    {log.engineName}
                  ...
                  <span className="text-[11px] font-mono text-[#FFF8F0]/30 truncate flex-1 min-w-0">
                    {log.summary ?? "\u2014"}
                  </span>
                </div>
              );
