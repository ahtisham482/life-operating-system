...
const ZONES = {
  today: {
    ...
    icon: "☀️",
    color: "#FF6B6B",
    description: "Track, score, and vote on your daily habits",
    views: [
      { key: "tracker", label: "Track Today" },
      { key: "scorecard", label: "Daily Score" },
      { key: "identity", label: "Identity Votes" },
    ],
    defaultView: "tracker",
  },
  build: {
    ...
    icon: "🏗️",
    color: "#2DD4BF",
    description: "Design systems, rewards, and friction for your habits",
    views: [
      { key: "architect", label: "Habit Blueprints" },
  ...
  grow: {
    ...
    icon: "🌱",
    color: "#A78BFA",
    description: "Level up with mastery, reviews, and challenges",
    views: [
      { key: "mastery", label: "Mastery" },
      { key: "guide", label: "Guide & Health" },
    ],
    defaultView: "mastery",
  },
} as const;
